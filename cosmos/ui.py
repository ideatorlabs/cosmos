...
cosmos obsidian --vault ~/Obsidian/Team  # link several repos' ledgers into one vault</pre>
 ...
 ['byitself','14 · What happens by itself',`
  ...
  <tr><td><b>Ledger branch</b> — <code>.cosmos/</code> is a worktree of the <code>cosmos</code> branch, ignored by your branches; a fresh clone attaches it on the first session start; a pruned worktree record is relinked; a session start warns if a branch has it merged</td><td>init · dreams · watcher</td><td>never in a feature branch</td></tr>
